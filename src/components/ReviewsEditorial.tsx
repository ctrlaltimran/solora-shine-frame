      ...
      <div className="space-y-7">
        {reviews.map((r, i) => (
          ...
          >
            ...
            />
            <Quote
              className="solora-review__quote absolute -left-[9px] top-2 h-4 w-4 text-foreground/30 bg-background transition-all duration-500 group-hover:text-foreground group-hover:-translate-y-0.5"
              strokeWidth={2.5}
            />
